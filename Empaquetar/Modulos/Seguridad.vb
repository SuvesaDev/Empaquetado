...
Public Module Seguridad
    ...
    Public Function RSM(ByVal Modulo As String, ByVal Nombre As String, Optional ByVal Menu As String = "") As Boolean
        ...
        Cx.DesConectar(Cx.sQlconexion)
    End Function
    Public Function VerificandoAcceso_a_Modulos(ByVal nombre_form As String, ByVal titulo As String, ByVal Usuario As String, Optional ByVal Menu As String = "") As Boolean
        Dim Nombre As String = nombre_form
